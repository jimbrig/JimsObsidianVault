...
- [tflint](https://github.com/terraform-linters/tflint) – Terraform linter for errors that the plan can’t catch.
- [tfenv](https://github.com/tfutils/tfenv) – Terraform version manager (Read more about it in the [How to Use tfenv to Manage Multiple Terraform Versions](https://spacelift.io/blog/tfenv) article)
- [checkov](https://github.com/bridgecrewio/checkov/) –  Terraform static analysis tool 
- [terratest](https://github.com/gruntwork-io/terratest/) – Go library that helps you with automated tests for Terraform
- [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) – Pre-commit git hooks for automation 
- [terraform-docs](https://github.com/terraform-docs/terraform-docs) – Quickly generate docs from modules
- [spacelift](https://spacelift.io/?utm_source=blog&utm_medium=text&utm_id=blogpost&utm_content=%7Bterraform_best_practices%7D) – Collaborative Infrastructure Delivery Platform for Terraform ([Terraform Cloud alternative](https://spacelift.io/terraform-cloud-alternative))
- [atlantis](https://github.com/runatlantis/atlantis) – Workflow for collaborating on Terraform projects
- [terraform-cost-estimation](https://github.com/antonbabenko/terraform-cost-estimation) – Free cost estimation service for your plans.
...
- [pluralith](https://www.pluralith.com/) - Terraform state visualization and automated generation of infrastructure documentation. 💲
...
- [Terrahaxs](https://www.terrahaxs.com/) - A GitOps Terraform CI/CD GitHub Application 💲
