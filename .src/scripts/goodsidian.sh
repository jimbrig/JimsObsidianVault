...
url="https://www.goodreads.com/review/list_rss/98715898?key=dnUwkoEWR2Oxjuk50_65ipgGgZx8OsaFgeR5d0UsrHJZCEXP&shelf=currently-reading"
# url for "Read":
readurl="https://www.goodreads.com/review/list_rss/98715898?key=dnUwkoEWR2Oxjuk50_65ipgGgZx8OsaFgeR5d0UsrHJZCEXP&shelf=read"
...
sed -e 's/<!\[CDATA\[//' -e 's/\]\]>//' \
-e 's/Jimmy.s bookshelf: currently-reading//' \
