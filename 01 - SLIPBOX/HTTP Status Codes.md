...
Tags: ["#Type/Note", "#Topic/Dev", "#Topic/Dev/WebDev", "#Topic/Dev/APIs"]
Aliases: [ "HTTP Status Codes", "REST Status Codes" ]
Links:
  - "[[MOC - Development|Development]]"
  - "[[Web Development]]"
  - "[[API|APIs]]"
  - "[[03 - AREAS/Technology/Networking/HTTP|HTTP]]"
---

# HTTP Status Codes

> [!SOURCE] Sources
> - *[cheat-sheets/misc/http-status-codes.md at main · ChristianLempa/cheat-sheets (github.com)](https://github.com/ChristianLempa/cheat-sheets/blob/main/misc/http-status-codes.md)*
> - 
...
|  Range  |      Description       |
|:-------:|:----------------------:|
| 100-199 | Informational Requests |
...
*Note created on [[2023-09-17]] and last modified on [[2023-09-17]].*
...
```dataview
list from [[HTTP Status Codes]] AND -"CHANGELOG" AND -"01 - SLIPBOX/HTTP Status Codes"
```
