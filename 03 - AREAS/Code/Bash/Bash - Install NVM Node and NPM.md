...
Alias: [ "Install NVM Node and NPM" ]
---

# Install NVM Node and NPM

> [!NOTE] Sources
> - *[Install NVM on Ubuntu with curl (github.com)](https://gist.github.com/jimbrig/7f7065d9a2e153db86cf082841db3ee1#file-install-nvm-sh)*
> - *[nvm-sh/nvm - install.sh](https://raw.githubusercontent.com/nvm-sh/nvm/v0.38.0/install.sh)*
...
*Link: [Install NVM on Ubuntu with curl (github.com)](https://gist.github.com/jimbrig/7f7065d9a2e153db86cf082841db3ee1#file-install-nvm-sh)*
...
```dataview
list from [[Bash - Install NVM Node and NPM]] AND -"CHANGELOG" AND -"Code/Bash/Install Scripts/Bash - Install NVM Node and NPM"
```
