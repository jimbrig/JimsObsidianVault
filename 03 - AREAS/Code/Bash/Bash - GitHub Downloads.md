...
- *[[03 - AREAS/Tools/Tools - Version Control/Github]] Personal Access Token must be supplied*
- Must have [[03 - AREAS/Technology/Programming/Command Line/Commands/curl]], [[wget]], and [[jq]] installed and on the system/user's `PATH` [[environment variable]].
...
> [!NOTE] See Also: 
> [[03 - AREAS/Technology/Programming/Command Line/Shell/PowerShell/PowerShell]] Version of Same Functionality: [[PowerShell - GitHub Downloads]]
