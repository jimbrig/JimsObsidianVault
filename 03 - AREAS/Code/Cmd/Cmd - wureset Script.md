...
Alias: [ "wureset", "Reset Windows Update Tool Scripts", "Reset Windows Update Tool" ]
---

# Reset Windows Update Tool Scripts (`wureset`)

> [!SOURCE] Sources
> - *[ManuelGil/Reset-Windows-Update-Tool: Troubleshooting Tool with Windows Updates (Developed in Dev-C++). (github.com)](https://github.com/ManuelGil/Reset-Windows-Update-Tool)*
> - *[Reset Windows Update Tool | Troubleshooting for Windows Update | Repair System Files, Registry, and Winsock (wureset.com)](https://wureset.com/)*

## Contents

- [Overview](#overview)
- [Usage](#usage)
- [Script - Lite](#script---lite)
...
> [!SOURCE] Source
> *[script-wureset-lite/wureset-lite.bat at main · wureset-tools/script-wureset-lite (github.com)](https://github.com/wureset-tools/script-wureset-lite/blob/main/wureset-lite.bat)*
...
The full script below performs the following steps:
...
> [!SOURCE] Source
> *[script-wureset/wureset.bat at main · wureset-tools/script-wureset · GitHub](https://github.com/wureset-tools/script-wureset/blob/main/wureset.bat)*
...
```dataview
list from [[Cmd - wureset Script]] AND -"CHANGELOG" AND -"Code/CMD/Windows Update/Cmd - wureset Script"
```
