---
ID: "6f8bda26-2a5d-413e-8c03-0f10a2b92600"
Date Created: "2023-03-22"
Date Modified: "2023-03-22"
Author: Jimmy Briggs <jimmy.briggs@jimbrig.com>
Title: "RStudio Configuration Notes.md"
Sources: 
  - [""](""): ""
ImageURL: ""
...
- Lyx - [LyX | LyX â The Document Processor](https://www.lyx.org/)
- Docker / Kubernetes
...
-   I highly recommend un-ticking the default âRestore .RDataâ settings box:
...
- R version settings allow RStudio to âpointâ to different R versions/interpreters, which may be faster for some projects.
...
3. When migrating R versions between major patch updates, you will need to re-install you library of R packages. This process can be vastly expedited utilizing `installr`âs helpful `installr::copy.packages.between.libraries()` function.
