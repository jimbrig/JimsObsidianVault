---
ID: "7421a996-9b44-4a8e-8b67-4f3a1f44eab7"
Date Created: "2023-03-22"
Date Modified: "2023-03-22"
Author: Jimmy Briggs <jimmy.briggs@jimbrig.com>
Title: "Plumber Logging.md"
Sources: 
  - [""](""): ""
ImageURL: ""
Tags: ["Development/R", "Development/API", "Development/API"]
Aliases:
  - "<% tp.file.title %>"
---
...
In this example, I use the [logger package](https://daroczig.github.io/logger/) to generate the actual log entries. Using this package isnât required, but it does provide some convenient functionality that we will take advantage of.
...
Now that weâve defined two endpoints (`/echo` and `/plot`), we can use `entrypoint.R` to setup logging using preroute and postroute hooks. 
...
This function takes an empty string and converts it into a dash (`"-"`). We will use this to ensure that empty log values still get recorded so that it is easy to read the log files. Weâre now ready to create our plumber router and register the hooks necessary for logging:
...
Source: [Plumber Logging Â· R Views (rstudio.com)](https://rviews.rstudio.com/2019/08/13/plumber-logging/)
