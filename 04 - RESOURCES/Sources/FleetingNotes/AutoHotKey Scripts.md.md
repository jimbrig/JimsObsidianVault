---
ID: "efc849e2-84f0-4f9a-9034-a66b655340e2"
Date Created: "2023-03-22"
Date Modified: "2023-03-22"
Author: Jimmy Briggs <jimmy.briggs@jimbrig.com>
Title: "AutoHotKey Scripts.md"
Sources: 
  - [""](""): ""
ImageURL: ""
Tags: ["Development", "Development/Scripts", "Development/Configuration", "Master", "Custom", "Text", "Toggle", "Global", "Obsidian", "Todoist", "Keeper", "Hotkey", "NoTrayIcon", "NoEnv", "SingleInstance", "NoTrayIcon", "NoEnv", "SingleInstance", "NoTrayIcon", "NoTrayIcon", "NoTrayIcon", "NoEnv", "Warn", "NoTrayIcon", "NoEnv", "SingleInstance", "a", "f1", "Include", "include", "Include", "if", "if", "F1"]
Aliases:
  - "<% tp.file.title %>"
---
...
- ð __C:\\Users\\jimbr\\Dev\\scripts\\AutoHotKey__
  - ð __Custom__
    - ð [Custom\-Text\-Expanders.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/Custom/Custom-Text-Expanders.ahk)
    - ð [Toggle\-Hidden\-Files\-and\-Folders.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/Custom/Toggle-Hidden-Files-and-Folders.ahk)
  - ð __Global\-Shortcuts__
    - ð [Keeper\-Global\-Shortcut.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/Global-Shortcuts/Keeper-Global-Shortcut.ahk)
    - ð [Obsidian\-Global\-Shortcut.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/Global-Shortcuts/Obsidian-Global-Shortcut.ahk)
    - ð [Todoist\-Global\-Shortcut.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/Global-Shortcuts/Todoist-Global-Shortcut.ahk)
  - ð __HotKeyHelp__
    - ð [HotKey Help \- Dialog.txt](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/HotKeyHelp/HotKey%20Help%20-%20Dialog.txt)
    - ð [HotkeyHelp.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/HotKeyHelp/HotkeyHelp.ahk)
    - ð [HotkeyHelp.ini](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/HotKeyHelp/HotkeyHelp.ini)
  - ð [Master.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/Master.ahk)

*Deprecated*

  	- ð __WinClip__
    	- ð [WinClip.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/WinClip/WinClip.ahk)
    	- ð [WinClipAPI.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/WinClip/WinClipAPI.ahk)
    	- ð [test.ahk](https://github.com/jimbrig/Scripts/tree/main/AutoHotKey/WinClip/test.ahk)
...
; ### Configuration ###
#NoEnv
#SingleInstance,Â Force
SendMode Input
SetWorkingDir,Â %A_ScriptDir%

;Â ### GlobalÂ ShortcutsÂ forÂ Programs ###
...
;Â ###Â Deprecated ###
;Â Run,Â ListHotKeys.ahk
;Â WinClip
;Â Run,Â "WinClip\WinClip.ahk"
```
	...
	for index, Script in Scripts_Scan	; Loop Through AHK Script Files
	{
		...
		if Txt_Ahk
		{
			for index_File_Path_Txt, File_Path_Txt in File_Paths_Txt
			{
				...
				if not ErrorLevel
					Script_File .= Parse_Delimiter "ï¿½ Hotkey Help Text File ï¿½" Parse_Delimiter Script_File_Txt	;  Append Txt File onto AHK File
			}
		}
		if !Script_File
			continue
		...
		Loop, Parse, Script_File, %Parse_Delimiter%, %Parse_OmitChar%	; Parse Each Line of Script File
		{
			...
			if (File_Line = "ï¿½ Hotkey Help Text File ï¿½")
			{
